...
<head>
    ...
    <link rel="stylesheet" href="includes/RubRegle.css">
</head>
<body>
<main id="main">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box">
                    ...
                    <h4><a href="ajouterRub.php" >Ajouter une nouvelle rubrique de paie</a></h4>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box">
                    <div class="icon"><i class="bx bx-file"></i></div>
                    <h4><a href="updateRub.php">Modifier/Supprimer une rubrique</a></h4>
                </div>
            </div>    
        </div>
    </div>
