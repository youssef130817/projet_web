...
if (isset($_POST['ValiderModif'])) {
    ...
    $r = $_POST['reg'];
    $i = $_POST['id'];
    $req5 = $bdd->prepare("UPDATE rubrique,calcul set rubrique.libelle_rub='$l',calcul.regle_de_calcul='$r'
                            where rubrique.id_rub='$i' and rubrique.id_rub = calcul.id_rub");
    $req5->execute();
}
if (isset($_POST['SuppRub'])) {
    $i = $_POST['id'];
    $req5 = $bdd->prepare("DELETE FROM calcul Where calcul.id_rub = '$i'");
    $req5->execute();
    $req5 = $bdd->prepare("DELETE FROM rubrique Where rubrique.id_rub='$i'");
    $req5->execute();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="includes/updateRub.css">
...
<body>
    <form action="updateRub.php" method="post" id="form">
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2>Liste des <b>rubriques</b></h2>
                                <select name="selectent" id="selection" onchange="RecupererValeurSelectUpdateRub()">
